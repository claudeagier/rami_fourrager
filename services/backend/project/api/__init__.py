...
from project.api.referentials.climatic_year_views import climatic_year_namespace
from project.api.roles import role_namespace
...
api.add_namespace(climatic_year_namespace, path="/climatic-years")
