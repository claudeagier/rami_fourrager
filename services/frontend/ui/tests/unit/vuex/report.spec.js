...
import { roundValues } from '@/plugins/utils'
import {
  getV647,
  getTotalHerd,
  getUGBSystem,
...
describe('report dimensioning', () => {
  ...
  it('get cost indicators', () => {
    const data = {
      '1_fourrage': [
        ...
        },
        {
          ...
          finalStock: 58.90390639999997,
          final_initialStock: 0.9039063999999684,
          purchase: 0,
          purchaseCost: 120,
          sale: 0,
          costOfSell: 0,
        ...
        },
        {
          ...
          finalStock: 80.67164792,
          final_initialStock: 1.671647919999998,
          purchase: 0,
          purchaseCost: 140,
          sale: 0,
          costOfSell: 0,
        ...
        {
          name: 'Ensilage de maïs et sorgho',
          category: '1_fourrage',
          code: 'EM',
          initialStock: 66,
          production: 120,
          consommation: 120.72059999999999,
          finalStock: 65.27940000000001,
          final_initialStock: -0.7205999999999904,
          purchase: 0.7205999999999904,
          purchaseCost: 180,
          sale: 0,
          costOfSell: 0,
          productionCost: 100,
      ...
      '2_concentrated': [
        {
          ...
          initialStock: 216,
          production: 450,
          consommation: 458.63999999999993,
          finalStock: 207.36000000000007,
          final_initialStock: -8.63999999999993,
          purchase: 8.63999999999993,
          purchaseCost: 46.8,
          sale: 459,
          costOfSell: 46.8,
          productionCost: 0,
        ...
        },
        {
          ...
          initialStock: -96,
          production: 0,
          consommation: 200.928,
          finalStock: -296.928,
          final_initialStock: -200.928,
          purchase: 200.928,
          purchaseCost: 98.2,
          sale: 0,
          costOfSell: 0,
      ...
      '3_straw': [
        {
          ...
          initialStock: 0,
          production: 52.5,
          consommation: 119.90978116923077,
          finalStock: -67.40978116923077,
          final_initialStock: -67.40978116923077,
          purchase: 67.40978116923077,
          purchaseCost: 50,
          sale: 0,
          costOfSell: 0,
          productionCost: 0,
    ...
    // rounded all
    const roundedResult = roundValues(indicators)
